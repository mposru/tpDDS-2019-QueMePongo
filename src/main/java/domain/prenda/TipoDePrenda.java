...
public class TipoDePrenda {
    ...
    public static final TipoDePrenda REMERA = new TipoDePrenda(Categoria.PARTE_SUPERIOR, Arrays.asList(Material.SEDA, Material.ALGODON),35,20);
    public static final TipoDePrenda REMERA_DEPORTIVA = new TipoDePrenda(Categoria.PARTE_SUPERIOR, Arrays.asList(Material.POLYESTER),30,20);

    public static final TipoDePrenda BUZO = new TipoDePrenda(Categoria.PARTE_SUPERIOR, Arrays.asList(Material.ALGODON),20,12);
    public static final TipoDePrenda PANTALON = new TipoDePrenda(Categoria.PARTE_INFERIOR, Arrays.asList(Material.JEAN, Material.ALGODON),30,0);
    ...
    public static final TipoDePrenda POLLERA = new TipoDePrenda(Categoria.PARTE_INFERIOR, Arrays.asList(Material.JEAN, Material.ALGODON),35,23);
    public static final TipoDePrenda SHORT = new TipoDePrenda(Categoria.PARTE_INFERIOR, Arrays.asList(Material.JEAN, Material.ALGODON),35,23);
    public static final TipoDePrenda BLUSA = new TipoDePrenda(Categoria.PARTE_SUPERIOR, Arrays.asList(Material.SEDA, Material.ALGODON),15,20);
    public static final TipoDePrenda MUSCULOSA = new TipoDePrenda(Categoria.PARTE_SUPERIOR, Arrays.asList(Material.ALGODON),25,40);
    public static final TipoDePrenda REMERA_MANGA_LARGA = new TipoDePrenda(Categoria.PARTE_SUPERIOR, Arrays.asList(Material.SEDA, Material.ALGODON),26,18);
    ...
    public static final TipoDePrenda CAMPERA = new TipoDePrenda(Categoria.PARTE_SUPERIOR,Arrays.asList(Material.POLYESTER,Material.ALGODON),16,5);
    ...
    public static final TipoDePrenda NINGUNO_SUPERIOR = new TipoDePrenda(Categoria.PARTE_SUPERIOR, Arrays.asList(Material.NINGUNO),50,36);
    ...
    public static final TipoDePrenda MAYA = new TipoDePrenda(Categoria.PARTE_INFERIOR,Arrays.asList(Material.POLYESTER),50,27);
